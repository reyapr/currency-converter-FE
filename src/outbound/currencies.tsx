...
import { CurrencyRequestInterface, RateRequestInterface } from './CurrenciesResponseInterface';
...
export const getRates = (req: RateRequestInterface) => {
  return axios.get(`${currenciesEndpoint}/find`, { params: req })
    .then(response => {
      console.log(`[SUCCESS] success to get calculated currency 
        request=${JSON.stringify(req)} response=${JSON.stringify(response)}`)
      return response.data;
